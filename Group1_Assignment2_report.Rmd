...
Using the set of predictors selected above, we now wish to compare the performance of logistic regression with tree-based methods. Tree-based methods may be more appropriate in this case due to all predictors being categorical. We consider a simple decision tree, a random forest, and XGboost.
...
Performance metrics of interest were accuracy, accuracy biased in favour of specificity, discrimination, and calibration.
